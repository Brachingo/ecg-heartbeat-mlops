...
def train(cfg: ConfigEntrenamiento):
    ...
    model = ClasificadorCNN(num_clases=cfg.num_clases, tamano_entrada=cfg.tamano_entrada).to(device) if cfg.arq == "CNN" else ClasificadorGRU(num_clases=cfg.num_clases, tamano_entrada=cfg.tamano_entrada).to(device)
